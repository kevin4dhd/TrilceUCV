...
public class PushNotificationsAdapter
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.card_view_holder, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.expiryDate.setText(newNotification.getExpiryDate());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            expiryDate = (TextView) itemView.findViewById(R.id.Fecha);
        }
    }
}

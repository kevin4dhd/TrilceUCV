...
public class ChatAdapter extends BaseAdapter{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        int TipoDeMensaje = chatMessage.TipoDeMensaje ;//Just a dummy check to simulate whether it me or other sender
        setAlignment(holder, TipoDeMensaje);
    ...
    private void setAlignment(ViewHolder holder, int TipoDeMensaje) {
        if (TipoDeMensaje==1) {

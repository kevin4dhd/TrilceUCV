...
public class Preferencias extends PreferenceFragment{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final EditTextPreference editTextPreference = (EditTextPreference) findPreference("op_user");
        editTextPreference.setSummary(GuardarDatos.CargarUsuario(getContext()));
    ...
    protected static void setListPreferenceData(ListPreference lp) {
        CharSequence[] entries = { "Basico", "Items", "Items 2", "Items 3"};
